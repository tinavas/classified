...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2015 at 07:52 AM
...
INSERT INTO `advertisement` (`id`, `user_id`, `category_id`, `advertise_title`, `photo_name`, `description`, `price`, `contact_name`, `email`, `mobile_number`, `state_id`, `city_id`, `address`, `status`) VALUES
(1, 1, 1, 'Initial Adverts', '1', 'Initial Adverts', 2000, '1234567890', 'jawadkhan.it@gmail.com', 1234567890, 1, 1, 'text address', 1);
...
--
-- Dumping data for table `advertise_comment`
--

INSERT INTO `advertise_comment` (`id`, `advertise_id`, `create_at`, `title`, `author_name`, `author_email`, `body`, `enabled`, `status`, `mark_spam`) VALUES
(3, 1, '2015-08-29 16:20:55', 'Test Title1.', 'Jawad Khan', 'jawadkhan.it@gmail.com', 'test text', NULL, 1, 1),
(6, 4, '2015-08-29 16:17:26', 'Test Title', 'Jawad Khan', 'jawadkhan.it@gmail.com', '', NULL, 1, 1),
(7, 7, '2015-08-29 16:18:34', 'Test Title7', 'Ali', 'jawadkhan.it@gmail.com', '', NULL, 1, 1);
...
INSERT INTO `category` (`id`, `title`, `image`, `description`, `parent_id`, `status`) VALUES
(1, 'Electronic', '', 'Electronics', 0, 1),
(2, 'vichle ', '3456789', 'dghjk', 0, 1);
...
CREATE TABLE IF NOT EXISTS `category_additional_fields` (
  ...
  `optional_field_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `catetory_additional_fields_fk0` (`category_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
